...
public class CSVExample {
    ...
    public static void main(String[] args) throws  Exception {
        ...
        recordReader.initialize(new FileSplit(new File("D:\\Alfa\\ML\\SensorData.csv")));
        ...
        /*
			...
			Sitting -> 5
         */
        int batchSize = 1098209;    //Iris data set: 150 examples total. We are loading all of them into one DataSet (not recommended for large data sets)
